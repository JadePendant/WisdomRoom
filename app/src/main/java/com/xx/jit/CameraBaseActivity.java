...
public class CameraBaseActivity extends Activity implements Callback{
    ...
    private AppData app;
    private String[] ip = {"172.168.55.17","172.168.55.44","172.168.55.36","172.168.55.13","172.168.55.38",
                            "172.168.55.50","172.168.55.10","172.168.55.14","172.168.55.26","172.168.55.30",
                            "172.168.55.11","172.168.55.33","172.168.55.37","172.168.55.39","172.168.55.16",
                            "172.168.55.21","172.168.55.41","172.168.55.22","172.168.55.24","172.168.55.52",
                            "172.168.55.49","172.168.55.68","172.168.55.31","172.168.55.29","172.168.55.25",
                            "172.168.55.40","172.168.55.58","172.168.55.63","172.168.55.60","172.168.55.64",
                            "172.168.55.67","172.168.55.59","172.168.55.66","172.168.55.57","172.168.55.35",
                            "172.168.55.56","172.168.55.61","172.168.55.69","172.168.55.62","172.168.55.65",
                            "172.168.55.53","172.168.55.51","172.168.55.23","172.168.55.34","172.168.55.54",
                            "172.168.55.55","172.168.55.15","172.168.55.18","172.168.55.27","172.168.55.43",
                            "172.168.55.47","172.168.55.45","172.168.55.46","172.168.55.42","172.168.55.19",
                            "172.168.55.28","172.168.55.32","172.168.55.48","172.168.55.12","172.168.55.20"};
    public  String ADDRESS = "172.168.55.20";
    public final int PORT = 8000;
    public final String USER = "admin";
    public final String PSD = "abc12345";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ADDRESS = ip[index];
        //Toast.makeText(CameraBaseActivity.this,""+index,Toast.LENGTH_LONG).show();
    ...
    private boolean initeSdk() {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_Init()) {
            Log.e(TAG, "HCNetSDK login is failed!");
            return false;
        }
